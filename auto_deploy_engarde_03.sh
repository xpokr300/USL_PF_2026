...
generate_pages() {
    ...
    echo "<!DOCTYPE html><html><head><meta charset='utf-8'><title>UŠL - Humanita</title>" > "$INDEX_FILE"
    echo "<style>
...
EOF
    ...
    echo "    <span id='hours'>00</span><span style='font-size: 0.4em; color: #666; margin-right: 10px;'>h</span>" >> "$INDEX_FILE"
    echo "    <span id='minutes'>00</span><span style='font-size: 0.4em; color: #666; margin-right: 10px;'>m</span>" >> "$INDEX_FILE"
    ...
    echo "<div class='menu-container' style='display: flex; justify-content: center; gap: 20px; margin: 20px 0; font-family: sans-serif;'><a href='https://sermliga.eu' style='color: #004494; text-decoration: underline; font-size: 20px'>Oficiální webová stránka UŠL</a><a href='https://sermliga.eu/wp-content/uploads/2026/02/Propozice_USL_28_3_2026.pdf' style='color: #004494; text-decoration: underline; font-size: 20px'>Propozice</a></div>" >> "$INDEX_FILE"
